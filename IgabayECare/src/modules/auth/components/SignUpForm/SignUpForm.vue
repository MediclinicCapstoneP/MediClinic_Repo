  ...
  >
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        ...
        <p class="text-gray-600">Join our healthcare platform as a patient</p>
      </div>

      <AppCard class="bg-white shadow-xl border-0">
        <template #header>
          <div class="text-center pb-4">
            <h3 class="text-xl font-semibold text-gray-900">Patient Registration</h3>
          </div>
        </template>
...
import { User, Eye, EyeOff, AlertCircle, CheckCircle } from 'lucide-vue-next';
