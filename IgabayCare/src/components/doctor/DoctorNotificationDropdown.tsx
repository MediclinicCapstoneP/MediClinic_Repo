...
interface DoctorNotificationDropdownProps {
  doctorUserId: string;
  className?: string;
}

export const DoctorNotificationDropdown: React.FC<DoctorNotificationDropdownProps> = ({
  doctorUserId,
  className = ''
}) => {
  ...
  useEffect(() => {
    ...
    const { unsubscribe } = DoctorNotificationService.subscribeToDoctorNotifications(
      doctorUserId,
      (notification) => {
                              ...
                              <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                                ...
                                {notification.appointment_time && (
                                  <span className="flex items-center">
                                    ...
                                    {new Date(notification.appointment_time).toLocaleString()}
                                  </span>
                                )}
                              </div>
                            )}
