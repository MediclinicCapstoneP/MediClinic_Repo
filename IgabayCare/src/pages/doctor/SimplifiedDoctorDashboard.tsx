...
import { 
  ...
  Star, DollarSign, ArrowUp, Clock, CheckCircle
} from 'lucide-react';
...
export const SimplifiedDoctorDashboard: React.FC = () => {
    ...
    try {
      ...
      if (statsResult.success && statsResult.stats) {
        ...
        setDashboardStats({
          ...
          weeklyAppointments: stats.upcomingAppointments || 0,
  ...
  const loadMockData = () => {
    ...
    setRecentActivity([
      {
        ...
        description: 'Sarah Johnson - General Checkup',
        time: '2 hours ago',
        status: 'completed'
      },
      {
        ...
        description: 'Michael Chen - Antibiotics prescribed',
        time: '4 hours ago',
        status: 'completed'
      },
      {
        ...
        description: 'Emily Davis joined your practice',
        time: '1 day ago',
        status: 'completed'
      }
    ]);
    ...
    // Mock notifications
    setNotifications([
      { id: '1', title: 'Appointment Reminder', message: 'Sarah Johnson at 9:00 AM' },
      { id: '2', title: 'Lab Results', message: 'Michael Chen results available' },
      { id: '3', title: 'Prescription Refill', message: 'Emily Davis requested refill' }
    ]);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            Good morning, Dr. {doctorProfile?.firstName}
          </h2>
